...
import Image from '.././assets/images/collections/necklaces.png';
						...
						<div className="row">
							<div className="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<div className="wrap">
									...
									<p className="name">Necklace 101</p>
							...
							<div className="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<div className="wrap">
									<img className="img-responsive" src={Image} alt="Bracelets" />
									<p className="name">Necklace 102</p>
									<p className="price">&#8369; 1,354.50</p>
							...
							<div className="col-xs-6 col-sm-4 col-md-4 col-lg-4">
								<div className="wrap">
									<img className="img-responsive" src={Image} alt="Bracelets" />
									<p className="name">Necklace 103</p>
									<p className="price">&#8369; 1,354.50</p>
									<span className="stocks-available">Stocks Available</span>
									<button className="btn btn-default">Add to Cart</button>
								</div>
